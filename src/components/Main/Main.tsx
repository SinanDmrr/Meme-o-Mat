    ...
    <main className="flex-1 flex flex-col items-center justify-start w-full px-5">
      ...
      <div className="meme w-full max-w-[570px] min-w-[300px] my-5 relative">
        ...
        <span
          ...
          className="absolute top-2 left-1/2 transform -translate-x-1/2 meme-text font-bold text-3xl text-shadow-lg-green w-[80%] inline-block text-center">
        ...
        <span
          ...
          className="absolute bottom-2 left-1/2 transform -translate-x-1/2 meme-text font-bold text-3xl text-shadow-lg-green w-[80%] inline-block text-center">
